//
//  MediatorFinishedViewController.m
//  ZhuZhuTruck
//
...
@interface MediatorFinishedViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MediatorFinishedViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (status.boolValue) {
        ...
        MediatorOrderDetailViewController *orderDetail = [[MediatorOrderDetailViewController alloc]initWithTenderStatus:RobTenderFailed];
        [self.navigationController pushViewController:orderDetail animated:YES];
    }
}
