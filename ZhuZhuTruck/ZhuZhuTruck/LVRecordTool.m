...
- (AVAudioRecorder *)recorder {
    if (!_recorder) {
        ...
        self.fileName = [NSString stringWithFormat:@"ios_user_phone%@record_time%@",user_phone(),[NSDate date]];
...
-(void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag{
    ...
    if ([self.delegate respondsToSelector:@selector(recordTool:didStopPlayingFlag:)]) {
        [self.delegate recordTool:self didStopPlayingFlag:flag];
    }
}
@end
